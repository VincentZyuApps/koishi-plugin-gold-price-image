...
export const FONT_ASSET_PARTS = [
  'data',
  'fonts',
  'LXGWWenKaiMono-Regular.ttf',
] as const;

export const CHART_ASSET_PARTS = [
  'data',
  'assets',
  'gold-price-image',
  'chart.umd.min.js',
...
export interface Config {
  ...
  fontAssetParts: string[];
  chartJsAssetParts: string[];
...
export const Config: Schema<Config> = Schema.intersect([
  ...
  Schema.object({
    ...
    maxXAxisTicks: Schema
      ...
      .max(200)
      .default(24)
      .description('横轴（X 轴）最大时间标签数量'),
    maxYAxisTicks: Schema
      .number()
      .min(3)
      .max(20)
      .default(9)
      .description('纵轴（Y 轴）最大金价标签数量'),
    imageType: Schema
      .union(['png', 'jpeg', 'webp'])
      .default('png')
      .description('图片输出格式'),
    ...
    fontMode: Schema
      .union([
        ...
        Schema.const('lxgw').description('使用插件自动下载的 LXGW WenKai Mono'),
    ...
    fontAssetParts: Schema
      .array(Schema.string())
      .default([...FONT_ASSET_PARTS])
      .disabled()
      .description('LXGW 共享字体路径片段；相对于 Koishi 根目录 ctx.baseDir，仅供查看'),
    chartJsAssetParts: Schema
      .array(Schema.string())
      .default([...CHART_ASSET_PARTS])
      .disabled()
